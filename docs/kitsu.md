...
| Operation | Method | Path | Query Params | Status |
|-----------|--------|------|--------------|--------|
| Fetch Collection | GET | `/episodes` | `page[limit]`, `page[offset]` | ❌ Not Implemented |
| Fetch Resource | GET | `/episodes/{id}` | — | ❌ Not Implemented |
...
| Operation | Method | Path | Query Params | Status |
|-----------|--------|------|--------------|--------|
| Fetch Collection | GET | `/categories` | `page[limit]`, `page[offset]` | ❌ Not Implemented |
| Fetch Resource | GET | `/categories/{id}` | — | ❌ Not Implemented |
...
| Operation | Method | Path | Status |
|-----------|--------|------|--------|
| Fetch Collection | GET | `/characters` | ❌ Not Implemented |
| Fetch Resource | GET | `/characters/{id}` | ❌ Not Implemented |
...
| Operation | Method | Path | Status |
|-----------|--------|------|--------|
| Fetch Collection | GET | `/people` | ❌ Not Implemented |
| Fetch Resource | GET | `/people/{id}` | ❌ Not Implemented |
...
| Operation | Method | Path | Status |
|-----------|--------|------|--------|
| Fetch Collection | GET | `/media-relationships` | ❌ Not Implemented |
| Fetch Resource | GET | `/media-relationships/{id}` | ❌ Not Implemented |
...
| Operation | Method | Path | Status |
|-----------|--------|------|--------|
| Fetch Collection | GET | `/mappings` | ❌ Not Implemented |
| Fetch Resource | GET | `/mappings/{id}` | ❌ Not Implemented |
...
| Operation | Method | Path | Status |
|-----------|--------|------|--------|
| Fetch Collection | GET | `/streamers` | ❌ Not Implemented |
| Fetch Resource | GET | `/streamers/{id}` | ❌ Not Implemented |
